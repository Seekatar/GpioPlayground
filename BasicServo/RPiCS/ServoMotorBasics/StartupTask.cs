...
namespace ServoMotorBasics
{
    public sealed class StartupTask : IBackgroundTask
    {
        ...
        double ForwardPulseWidth = 2.4;
        //A pulse of 1ms moves the servo counterclockwise
        double BackwardPulseWidth = .544;

        double MiddlePulseWidth = 1.5;
        ...
        public void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            servoPin = controller.OpenPin(13); // GPIO #13 (not pin)
        ...
        private void Tick(ThreadPoolTimer timer)
        {
            if (currentPulseWidth == ForwardPulseWidth)
                currentPulseWidth = MiddlePulseWidth;
            else if (currentPulseWidth == MiddlePulseWidth)
